...
public interface SuggestionLogApi {
    ...
    @Operation(summary = "제안 목록 조회", description = "groupId 기준으로 제안 로그 목록을 페이지 단위로 조회합니다. locationId로 추가 필터링 가능합니다. 정렬은 항상 최신순 고정입니다.")
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(schema = @Schema(implementation = SuggestionLogResponse.class)))
    ResponseEntity<Page<SuggestionLogResponse>> getSuggestionLogs(
